...
<div id="mobile_np_select" class="d-block">
...
{capture name="js_code"}
	var npWarehouseSelected = "{$np_warehouse_selected|escape:'javascript'}";
	var mobileNpText = "{$mobile_np_text|escape:'javascript'}";
{/capture}